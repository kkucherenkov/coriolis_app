...
import 'package:coriolis_app/common/shared_preference_helper.dart';
  ...
  setInitialLocalLanguage() async {
    _sharedPrefsHelper.appCurrentLanguage.then((currentLanguageCode) async {
      if ((currentLanguageCode == '') || (currentLanguageCode == null)) {
        ...
        const MethodChannel _channel = const MethodChannel('uk.spiralarm.flutter/devicelocale');
        final List deviceLanguages = await _channel.invokeMethod('preferredLanguages');
