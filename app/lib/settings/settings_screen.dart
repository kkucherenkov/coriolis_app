...
import 'package:coriolis_app/common/globals.dart';
...
import 'package:coriolis_app/model/menu_option_model.dart';
import 'package:coriolis_app/widgets/drop_down_picker.dart';
      ...
      children: <Widget>[
        ListTile(
          ...
          trailing: DropdownPicker(
            ...
            selectedOption: Provider.of<LanguageProvider>(context).currentLanguage,
            onChanged: (value) {
        ...
        ListTile(
          ...
          trailing: DropdownPicker(
            ...
            onChanged: (value) {
              Provider.of<ThemeProvider>(context, listen: false).updateTheme(value);
            },
          ),
        ),
        ListTile(
