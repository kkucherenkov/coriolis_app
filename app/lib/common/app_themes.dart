...
class AppThemes {
  ...
  static final TextTheme _lightTextTheme = TextTheme(
    display4: TextStyle(fontSize: 20.0, color: _lightTextColor),
    body2: TextStyle(fontSize: 16.0, color: _lightTextColor),
    body1: TextStyle(fontSize: 14.0, color: Colors.grey),
    button: TextStyle(
        fontSize: 15.0, color: _lightTextColor, fontWeight: FontWeight.w600),
    title: TextStyle(fontSize: 16.0, color: _lightTextColor),
    subhead: TextStyle(fontSize: 16.0, color: _lightTextColor),
...
//text theme for dark theme
  ...
  static final TextTheme _darkTextTheme = TextTheme(
    display4: TextStyle(fontSize: 20.0, color: _darkTextColor),
    body2: TextStyle(fontSize: 16.0, color: _darkTextColor),
    body1: TextStyle(fontSize: 14.0, color: Colors.grey),
    button: TextStyle(
        fontSize: 15.0, color: _darkTextColor, fontWeight: FontWeight.w600),
    title: TextStyle(fontSize: 16.0, color: _darkTextColor),
    subhead: TextStyle(fontSize: 16.0, color: _darkTextColor),
